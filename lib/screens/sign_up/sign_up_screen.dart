      ...
      body: ListView(
        children: [
          Align(
              ...
              child: Image(image: AssetImage('images/sign_up_first_flower.png'),)),
          Column(
            children: [
              Padding(
                padding:  EdgeInsets.only(left: width*0.09,right: width*0.013,top: height*0.04,bottom: height*0.02),
                child: Row(
                  children: [
                    Text(
                      'Create New Account',
              ...
              Padding(
                padding:  EdgeInsets.only(left: width*0.13,right: width*0.01,top: 0,bottom: 0),
                child: Row(
                  children: [
                    Text(
             ...
             Row(
               children: [
                 Image(image: AssetImage('images/sign_up_second_flower.png')),
                 Padding(
                   padding:  EdgeInsets.only(left: width*0.14,right: width*0.01,top: height*0.03,bottom: 0),
                   child: Container(
...
child: Icon(
  ...
  color: kTextFieldBorder,
          ...
          Padding(
            padding:  EdgeInsets.only(left: width*0.1,right: width*0.1,top: height*0.06,bottom: 0),
